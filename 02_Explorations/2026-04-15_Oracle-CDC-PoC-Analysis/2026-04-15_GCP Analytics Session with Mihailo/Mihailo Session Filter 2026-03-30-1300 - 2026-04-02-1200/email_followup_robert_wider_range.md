...
Eine Sache ist uns aufgefallen: das SQL mit `SYSDATE - 3` hat uns nur Daten vom 13.-16. April geliefert. Der eigentliche POC-Zeitraum war aber **26. März bis 9. April** — da lief der Datastream Test auf TMS1060_SENDUNG.
...
FROM v$archived_log
WHERE first_time BETWEEN TO_DATE('2026-03-26', 'YYYY-MM-DD')
                      AND TO_DATE('2026-04-09', 'YYYY-MM-DD')
ORDER BY first_time;
```
