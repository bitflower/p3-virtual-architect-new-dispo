```
  ...
  Provider: Oracle | User: BRIDGE_USER | Schema: TMS1060
...
==================================================================
  ...
  [X] PDIS_TRANSPORTORDER.CREATETRANSPORTORDERFROMLEG NOT FOUND  EXECUTE DENIED
  ...
  [X] PDIS_TRANSPORTORDER.REMOVESHIPMENT         NOT FOUND  EXECUTE DENIED
...
==================================================================
  [X] Level 1.0 (Existence):  73/77 found, 1 skipped, 4 NOT FOUND
  [+] Level 1.5 (Signature):  42/42 match, 36 unchecked (no expected args)
  [X] Level 2.0 (Permission): 73/77 granted, 1 skipped, 4 DENIED
